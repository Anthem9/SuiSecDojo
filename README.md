...
- `contracts/`：Sui Move challenge 合约与测试，Challenge 01/02/03/04 已可在 testnet 领取和 solve。
...
```text
0xeec2ac356008c33dbb300536ee2b4924c5f0a619d57b3bfe541728c16256dc88
```

当前 Challenge Registry：

```text
0x239e2737cf77d91359a714e467aae7d0a606b43c26a695572e6146e88c062abf
```
...
3. 点击 `Claim Instance` 领取 Challenge 01/02/03/04 instance。
...
当前 testnet package 已包含 registry 模块，registry object 已注册 Challenge 01/02/03/04 的 metadata。
