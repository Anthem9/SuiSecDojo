...
- `contracts/`：Sui Move challenge 合约与测试，Challenge 01/02/03/04/05/06 已可在 testnet 领取和 solve。
...
```text
0x1787b2cde6ded65f6810132c3fdfe6e334de617c7eb788dbee1bd94c2112c306
```

当前 Challenge Registry：

```text
0x6afb42dc4da1931194536245f2fa5d80991e9635e48b51fd6f6c01e779101451
```
...
3. 点击 `Claim Instance` 领取 Challenge 01/02/03/04/05/06 instance。
...
当前 testnet package 已包含 registry 模块，registry object 已注册 Challenge 01/02/03/04/05/06 的 metadata。
