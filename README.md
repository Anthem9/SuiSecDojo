...
- `contracts/`：Sui Move challenge 合约与测试，Challenge 01/02/03/04/05 已可在 testnet 领取和 solve。
...
```text
0x6f582b14ffa3c69e6c478311b4f89865392c001af7ceeadc70d81bf1b3988b0b
```

当前 Challenge Registry：

```text
0xe6155ddab78e4ecb09f1208273e3e496558f43d06ba50fe6104cbd2f25536193
```
...
3. 点击 `Claim Instance` 领取 Challenge 01/02/03/04/05 instance。
...
当前 testnet package 已包含 registry 模块，registry object 已注册 Challenge 01/02/03/04/05 的 metadata。
