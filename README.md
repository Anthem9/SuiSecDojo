...
- `contracts/`：Sui Move challenge 合约与测试，Challenge 01/02/03 已可在 testnet 领取和 solve。
...
```text
0xda44240d02c4581e1f8fd1a60f44061bfece78a2f9f52fc3ffc678230766aea6
```

当前 Challenge Registry：

```text
0xb6625bf5d08b3aad7bd4712869f85a7ef51a0af4d9ccdfb842384bbe3c20acb5
```
...
3. 点击 `Claim Instance` 领取 Challenge 01/02/03 instance。
